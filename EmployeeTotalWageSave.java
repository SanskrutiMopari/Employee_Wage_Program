...
public class EmployeeTotalWageSave {
    //Constants for class
    ...
    public EmployeeTotalWageSave(String companyName, int wagePerHr, int numWorkingDays, int maxHrsPerMonth) {
    ...
    public static void main(String[] args) {
        ...
        EmployeeTotalWageSave jio = new EmployeeTotalWageSave("JIO", 20, 10, 30);
        EmployeeTotalWageSave vodafone = new EmployeeTotalWageSave("VODAFONE", 15, 5, 25);
